...
public class RobotsParser extends Parser {
  ...
  private void parseLine(
    ...
    try {
      ...
      log("No key found.", robotsTxtBodyBytes, lineBegin, lineEnd, lineNumber);
      return;
    }

    DirectiveType directiveType = parseDirective(key);
    if (directiveType == DirectiveType.UNKNOWN) {
      log("Unknown key.", robotsTxtBodyBytes, lineBegin, lineEnd, lineNumber);
    }
    ...
    try {
      ...
      log("No value found.", robotsTxtBodyBytes, lineBegin, lineEnd, lineNumber);
      value = "";
